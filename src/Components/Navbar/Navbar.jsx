...
const Navbar = () => {
  ...
  {/*Menu DeskTop*/}
  return (
    <nav className="bg-red-700 shadow-sm p-4 rounded-sm ">
      <div className="flex justify-around items-center">
        ...
        <ul className="hidden md:flex md:flex-row md:gap-6 text-white">
          <li className="text-xl transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-indigo-700 p-2 rounded-sm">
